...
def evf():
    ...
    #         return 30
    #     if ('ooo--' or '-ooo-' or '--ooo' or 'o--oo' or 'oo--o' or 'o-o-o') in _str:
    #         return -30
    ...
    for _str in strings:
        if ('xxx--' or '-xxx-' or '--xxx' or 'x-x-x' or 'xx-x-' or 'x-xx-' or 'x--xx' or 'xx--x' or '-x-xx' or 'xxx--') in _str:
            return 30

    for _str in strings:
        if ('ooo--' or '-ooo-' or '--ooo' or 'o-o-o' or 'oo-o-' or 'o-oo-' or 'o--oo' or 'oo--o' or '-o-oo' or 'ooo--') in _str:
            return -30
...
#     print('Enter x coordinate of your move:')
#     i = int(input())
#     print('Enter y coordinate of your move:')
#     j = int(input())
#
#     board[i] = rep_char_in_string(board[i], j, 'o')
#     return i, j
...
def human():
    ...
    while True:
        ...
        if board[i][j] == '-':
            board[i] = rep_char_in_string(board[i], j, 'o')
            return i, j
        print ('wrong coordinate.enter again')
